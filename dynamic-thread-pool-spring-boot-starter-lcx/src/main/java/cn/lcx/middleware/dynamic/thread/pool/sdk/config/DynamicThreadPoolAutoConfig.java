package cn.lcx.middleware.dynamic.thread.pool.sdk.config;

import cn.lcx.middleware.dynamic.thread.pool.sdk.domain.DynamicThreadPoolService;
import cn.lcx.middleware.dynamic.thread.pool.sdk.domain.IDynamicThreadPoolService;
...
import cn.lcx.middleware.dynamic.thread.pool.sdk.registry.redis.RedisRegistry;
import cn.lcx.middleware.dynamic.thread.pool.sdk.trigger.job.ThreadPoolDataReportJob;
import cn.lcx.middleware.dynamic.thread.pool.sdk.trigger.listener.ThreadPoolConfigAdjustListener;
...
public class DynamicThreadPoolAutoConfig {
    ...
    public DynamicThreadPoolService dynamicThreadPollService(ApplicationContext applicationContext, Map<String, ThreadPoolExecutor> threadPoolExecutorMap, RedissonClient redissonClient) {
        ...
        DynamicThreadPoolService threadPoolService = new DynamicThreadPoolService(applicationName, threadPoolExecutorMap);
